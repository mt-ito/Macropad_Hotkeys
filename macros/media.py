...
app = {  # REQUIRED dict, must be named 'app'
    ...
    "macros": [  # List of button macros...
        ...
        # 1st row ----------
        (0x000000, "", []),
        (0x000020, "Vol+", Toolbar(ConsumerControlCode.VOLUME_INCREMENT)),
        (0x202020, "Bright+", Toolbar(ConsumerControlCode.BRIGHTNESS_INCREMENT)),
        # 2nd row ----------
        (0x000000, "", []),
        (0x000020, "Vol-", Toolbar(ConsumerControlCode.VOLUME_DECREMENT)),
        (0x202020, "Bright-", Toolbar(ConsumerControlCode.BRIGHTNESS_DECREMENT)),
        # 3rd row ----------
        (0x000000, "", []),
        (0x200000, "Mute", Toolbar(ConsumerControlCode.MUTE)),
        (0x000000, "", []),
        # 4th row ----------
        (0x202000, "<<", Toolbar(ConsumerControlCode.SCAN_PREVIOUS_TRACK)),
        (0x002000, "Play/Pause", Toolbar(ConsumerControlCode.PLAY_PAUSE)),
        (0x202000, ">>", Toolbar(ConsumerControlCode.SCAN_NEXT_TRACK)),
        # Encoder button ---
        (0x000000, "", []),
    ],
}
